...
Dendron is a highly opinonated note taking tool that focuses on **hierarichal note taking**. It provides the freedom of Roam's _every note exists everywhere philosophy_ while layering on top **flexible hierarchies** to keep track of it all. 
