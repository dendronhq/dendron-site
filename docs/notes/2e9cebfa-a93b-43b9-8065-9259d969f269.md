...
---
# 2020-10-19 Release Notes (version 0.14)
...
- keep dendron sustainable through our environmentalist plans
- direct child filter to help gradually expand your hiearchies 
- publish dendron markdown to regular markdown `Publish Pods`
- realtime schema validation when saving
- numerous enhancements across all areas in Dendron
- option to set a generated table of contents when publishing
- numerous bug fixes across all areas in dendron

## Community

- introducing the **Horitculutralist** role reserved for folks who have contributed to the Dendron code base: 👨‍🌾👩‍🌾
