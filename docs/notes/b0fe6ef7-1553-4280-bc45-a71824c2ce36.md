...
Dendron finds the **usable center** between the two extremes by supporting the linking of any two arbitrary notes through backlinks while also maintaining a **canonical hierarchy** for every note. We do this through a form of **structured note-taking** that relies on the combination of [hierarchies ](notes dendron.topic.hierarchies), [schemas ](notes dendron.topic.schema), and [path based lookups ](notes dendron.topic.lookup). Read our [quickstart ](notes dendron.quickstart) to learn about the details.
...
See our core [features ](notes dendron.features) that help you manage your notes.

## Getting Started

To get started, you can follow the instructions in [quickstart ](notes dendron.quickstart).
...
See the [FAQ ](notes dendron.faq) for answers for common questions.
