...
2. It makes it much easier to perform certain refactoring operations. For example, say you had the following [schema ](c5e5adde-5459-409b-b34d-a0d75cbb1052)
   ```yml
   - id: a-parent
   children:
       - child-a
   ...
   ```
3. It allows us to create [stubs ](c5e5adde-5459-409b-b34d-a0d75cbb1052) for parts of the hierarchy that don't exist and not clutter our file system with empty folders. With the classical folder hierarchy
   ```
   .
   └── a-parent
       └── child-a
