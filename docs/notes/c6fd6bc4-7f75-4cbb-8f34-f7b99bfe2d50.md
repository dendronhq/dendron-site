...
Your workspace is made up of **vaults**. A dendron vault stores a collection of related notes. If your familiar with git, it's just like a code repo. By default, Dendron creates a _vault.main_ folder when you first initialize a **workspace**. All your notes are stored on a per vault basis.
