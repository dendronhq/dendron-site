(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://wiki.dendron.so/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://wiki.dendron.so/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://wiki.dendron.so/assets/css/just-the-docs-' + theme + ".css"
      );
    };
