...
-   support custom port for preview ([[docs|dendron.topic.publishing-legacy.configuration#previewport]])
...
-   disable git linking on a per note basis ([[docs|dendron.topic.publishing-legacy.configuration#gitnolink]])
-   set a custom path for git url ([[docs|dendron.topic.publishing-legacy.configuration#gitnotepath]])
...
-   [[skipLevels|dendron.topic.publishing-legacy.configuration#skiplevels]] also applies to children lins
...
![[dendron.topic.publishing-legacy.changelogs#summary,1:#*]]
...
-   better block quotes ([[docs|dendron.topic.publishing-legacy.misc#blockquote]])
...
-   new docs on using dendron for [[blogging|dendron.topic.publishing-legacy.blogging]]
...
![[dendron.topic.publishing-legacy.features#backlinks,1]]
