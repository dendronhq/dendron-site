...
- this feature is limited to [[environmentalist|community.discord.roles#environmentalist]] 
...
### Pre-requisites
- have a [[sprout or higher level plan|community.discord.roles#environmentalist]] (note: we manage membership on a separate platform. be sure to register with the same email as you do for Dendron)
