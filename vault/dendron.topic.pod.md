...
For example, you might want to use our [[markdown pod|dendron.topic.pod.builtin.markdown]] to take a note with [[note references|dendron.topic.references]] and publish it as a regular markdown note to use in a github issue or another tool.
