...
Think of it as a **cache for everything that you care about** - if you've spent **more than five minutes** solving a problem, you should **never** spent any more time solving the same exact problem. 
