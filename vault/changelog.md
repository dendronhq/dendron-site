...
### Enhancements
- enhance(workspace): add new doctor command, `fixRemoteVaults`, to fix remote vaults that don't have a remote set ([[docs|dendron://dendron.dendron-site/dendron.topic.doctor#fixremotevaults]]) (#2484) @kaan
- enhance(publish): faster first load by reducing size of the tree menu (#2379) @eleweek
